...
def cse01(request):
    ...
    if(request.method=='POST'):
        ...
        if(form.is_valid()):
            form.save(commit=True)
            return redirect('/success/')
    return render(request,'register2.html',{'var2':var2,'event_name':event_name,'event_description':event_description,})
...
def mca02(request):
    ...
    if(request.method=='POST'):
        ...
        if(form.is_valid()):
            form.save(commit=True)
            return redirect('/success/')
    return render(request,'register1.html',{'var2':var2,'event_name':event_name,'event_description':event_description,})
